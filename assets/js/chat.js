...
(function () {
  ...
  const SITE_URL        = 'https://novadev-audit.vercel.app';
  ...
  const html = `
    <style>${styles}</style>
    <button id="nd-chat-bubble" aria-label="Chat with Nova Dev AI assistant">
    ...
    <div id="nd-chat-win" role="dialog" aria-modal="true" aria-label="Chat with Nova Dev assistant" hidden>
      <div class="nd-hdr">
        <div class="nd-hdr-info">
          ...
          <div class="nd-hdr-text">
            <strong>Nova Dev Assistant</strong>
  ...
  function greet() {
    const greetings = [
      "👋 Hi! I'm the Nova Dev assistant. We build premium websites & apps from €150. What kind of project are you working on?",
      "👋 Hello! I help businesses get professional websites. Landing pages from €150, full sites from €990. What brings you here today?",
      "👋 Hi there! Nova Dev here — premium web & mobile development for French and European businesses. How can I help you?"
    ];
